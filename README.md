...
4. For HPC, you will need to downgrade the version of pytorch by typing `pip3 install --upgrade torch torchvision --index-url https://download.pytorch.org/whl/cu128`
